...
from baselines.ensemble_ddpg.ensemble_ddpg import EnsembleDDPG
...
def train(env, nb_epochs, nb_epoch_cycles, render_eval, reward_scale, render, param_noise, actor, critics,
    ...
    agent = EnsembleDDPG(actor, critics, memory, env.observation_space.shape, env.action_space.shape,
            ...
            for cycle in range(nb_epoch_cycles):
                ...
                for t_rollout in range(nb_rollout_steps):
                    ...
                    if t < initial_random_steps:
                        ...
                        action, _ = agent.pi(obs, apply_noise=True, compute_Q=False)
